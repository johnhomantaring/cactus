...
describe("PluginLedgerConnectorQuorum", () => {
  ...
  beforeAll(async () => {
    ...
    const rpcApiWsHostMember1 = keys.quorum.member1.wsUrl;
    const rpcApiWsHostMember2 = keys.quorum.member2.wsUrl;
    const rpcApiWsHostMember3 = keys.quorum.member3.wsUrl;
